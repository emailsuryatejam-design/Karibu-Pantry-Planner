    ...
    <div class="w-full max-w-sm">
        ...
        <div class="mt-4">
            <a href="/admin-login.php"
                class="w-full flex items-center justify-center gap-2 border border-slate-200 text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition rounded-xl py-2.5 text-sm font-medium">
